...
public class CommandLineInterface {
        ...
        public static File getFile(String[] args) {
                ...
                System.out.println(
                                "====================================================================================================");
                if (args.length == 0 || (!args[0].startsWith(fileShortFull)
                                && !args[0].startsWith(fileLongFull))) {
                        String additionalMSG = "";
                        if (args.length > 0 && !args[0].startsWith(helpShort)
                                        && !args[0].startsWith(helpLong)) {
                                additionalMSG = "Missing the " + fileShort + " or " + fileLong
                                                + " param";
                        }
                        System.out.println(
