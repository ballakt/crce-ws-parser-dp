...
public class Example {
    ...
    void parseClass(ClassReader classReader, EClassVisitor visitor) {
    ...
    public static void main(String[] args) throws IOException {
        File jarFile = new File(
                "/home/tomas/projects/crce-ws-parser-dp/crce-client-webservices-indexer/target/classes/cz/zcu/kiv/crce/examples/asm/test.jar");
        loadClasses(jarFile);
    }
}
